#
#  Be sure to run `pod spec lint VerbalExpressions-for-Objective-C.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of VerbalExpressions-for-Objective-C in Markdown format.
  ...
  s.source       = { :git => "https://github.com/zakdances/VerbalExpressions-for-Objective-C.git", :tag => "0.0.1" }
